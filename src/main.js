...
const createFiles = async (edition) => {
  ...
  for (let i = 1; i <= edition; i++) {
    ...
    // console.log(layers);
    let metaAttributes = await attributes;
    ...
    const Metadata = {
      ...
      image: "image.png",
      properties: {
        creators: [{ address: "7fDWZouvRYXww4SHTJAt195J5uM2uxUxFgytEC2BfvmE", share: 100 }],
        files: [{ uri: `${i}.png`, type: "image/png" }],
      },
      tags: metaAttributes
    };
    fs.writeFileSync(`${buildDir}/${i}.json`, JSON.stringify(Metadata));
